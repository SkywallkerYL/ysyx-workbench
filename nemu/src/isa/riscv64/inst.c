...
//R
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , RI, s->dnpc = cpu.mepc;if(cpu.mstatus&MPIE)cpu.mstatus = cpu.mstatus|MIE;else cpu.mstatus = cpu.mstatus & (~ (MIE));cpu.mstatus = cpu.mstatus|((MPIE)););
//B
  //beqz 是=0分支    src2 = 0
