...
//R
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , RI, s->dnpc = cpu.mepc;if(cpu.mstatus&MIE)cpu.mstatus = cpu.mstatus|MPIE;else cpu.mstatus = cpu.mstatus & (~ (MPIE));cpu.mstatus = cpu.mstatus&(~(MIE)););
//B
  //beqz 是=0分支    src2 = 0
