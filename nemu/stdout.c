# 0 "src/isa/riscv64/reg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/isa/riscv64/reg.c"
# 16 "src/isa/riscv64/reg.c"
...
# 17 "src/isa/riscv64/reg.c" 2
# 1 "src/isa/riscv64/local-include/reg.h" 1
# 21 "src/isa/riscv64/local-include/reg.h"
...
# 33 "src/isa/riscv64/reg.c" 3 4
                                     _Bool 
# 33 "src/isa/riscv64/reg.c"
                                          *success) {
# 48 "src/isa/riscv64/reg.c"
 for (size_t i = 0; i < 32; i++)
 {
