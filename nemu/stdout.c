...
# 64 "src/cpu/difftest/dut.c"
 "ref_so_file != NULL"
# 64 "src/cpu/difftest/dut.c" 3 4
 , "src/cpu/difftest/dut.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "src/cpu/difftest/dut.c"
                            ;
...
void difftest_step(vaddr_t pc, vaddr_t npc) {
  ...
  if (skip_dut_nr_inst > 0) {
    ...
    if (skip_dut_nr_inst == 0)
      do { if (!(0)) { (fflush(
# 118 "src/cpu/difftest/dut.c" 3 4
     stdout
# 118 "src/cpu/difftest/dut.c"
     ), fprintf(
# 118 "src/cpu/difftest/dut.c" 3 4
     stderr
# 118 "src/cpu/difftest/dut.c"
...
# 118 "src/cpu/difftest/dut.c"
     "0"
# 118 "src/cpu/difftest/dut.c" 3 4
     , "src/cpu/difftest/dut.c", 118, __extension__ __PRETTY_FUNCTION__); }))
# 118 "src/cpu/difftest/dut.c"
     ; } } while (0);
    return;
  }
  ...
  if (is_skip_ref) {
    ...
    ref_difftest_regcpy(&cpu, DIFFTEST_TO_REF);
    is_skip_ref = 
# 125 "src/cpu/difftest/dut.c" 3 4
                 0
# 125 "src/cpu/difftest/dut.c"
                      ;
    return;
  }
