...
static void trace_and_difftest(Decode *_this, vaddr_t dnpc) {
  ...
  if (
# 37 "src/cpu/cpu-exec.c" 3 4
     1
# 37 "src/cpu/cpu-exec.c"
...
# 53 "src/cpu/cpu-exec.c" 3 4
                                     "l" "x" 
# 53 "src/cpu/cpu-exec.c"
                                              ":", s->pc);
...
# 88 "src/cpu/cpu-exec.c" 3 4
   _Bool 
# 88 "src/cpu/cpu-exec.c"
        change = test_change();
...
static void statistic() {
  setlocale(
# 97 "src/cpu/cpu-exec.c" 3 4
 1
# 97 "src/cpu/cpu-exec.c"
 , "");

  do { printf("\33[1;34m" "[%s:%d %s] " "host time spent = " "%'" 
# 99 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 99 "src/cpu/cpu-exec.c"
 " us" "\33[0m" "\n", "src/cpu/cpu-exec.c", 99, __func__, g_timer); do { extern FILE* log_fp; extern 
# 99 "src/cpu/cpu-exec.c" 3 4
 _Bool 
# 99 "src/cpu/cpu-exec.c"
...
# 99 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 99 "src/cpu/cpu-exec.c"
 " us" "\33[0m" "\n", "src/cpu/cpu-exec.c", 99, __func__, g_timer); fflush(log_fp); } } while (0); } while (0);
  do { printf("\33[1;34m" "[%s:%d %s] " "total guest instructions = " "%'" 
# 100 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 100 "src/cpu/cpu-exec.c"
 "\33[0m" "\n", "src/cpu/cpu-exec.c", 100, __func__, g_nr_guest_inst); do { extern FILE* log_fp; extern 
# 100 "src/cpu/cpu-exec.c" 3 4
 _Bool 
# 100 "src/cpu/cpu-exec.c"
...
# 100 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 100 "src/cpu/cpu-exec.c"
 "\33[0m" "\n", "src/cpu/cpu-exec.c", 100, __func__, g_nr_guest_inst); fflush(log_fp); } } while (0); } while (0);
  if (g_timer > 0) do { printf("\33[1;34m" "[%s:%d %s] " "simulation frequency = " "%'" 
# 101 "src/cpu/cpu-exec.c" 3 4
                  "l" "u" 
# 101 "src/cpu/cpu-exec.c"
                  " inst/s" "\33[0m" "\n", "src/cpu/cpu-exec.c", 101, __func__, g_nr_guest_inst * 1000000 / g_timer); do { extern FILE* log_fp; extern 
# 101 "src/cpu/cpu-exec.c" 3 4
                  _Bool 
# 101 "src/cpu/cpu-exec.c"
...
# 101 "src/cpu/cpu-exec.c" 3 4
                  "l" "u" 
# 101 "src/cpu/cpu-exec.c"
                  " inst/s" "\33[0m" "\n", "src/cpu/cpu-exec.c", 101, __func__, g_nr_guest_inst * 1000000 / g_timer); fflush(log_fp); } } while (0); } while (0);
  else do { printf("\33[1;34m" "[%s:%d %s] " "Finish running in less than 1 us and can not calculate the simulation frequency" "\33[0m" "\n", "src/cpu/cpu-exec.c", 102, __func__); do { extern FILE* log_fp; extern 
# 102 "src/cpu/cpu-exec.c" 3 4
      _Bool 
# 102 "src/cpu/cpu-exec.c"
      log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Finish running in less than 1 us and can not calculate the simulation frequency" "\33[0m" "\n", "src/cpu/cpu-exec.c", 102, __func__); fflush(log_fp); } } while (0); } while (0);
}
...
# 132 "src/cpu/cpu-exec.c"
     "\33[0m" "\n", "src/cpu/cpu-exec.c", 132, __func__, (nemu_state.state == NEMU_ABORT ? "\33[1;31m" "ABORT" "\33[0m" : (nemu_state.halt_ret == 0 ? "\33[1;32m" "HIT GOOD TRAP" "\33[0m" : "\33[1;31m" "HIT BAD TRAP" "\33[0m")), nemu_state.halt_pc); do { extern FILE* log_fp; extern 
# 132 "src/cpu/cpu-exec.c" 3 4
     _Bool 
# 132 "src/cpu/cpu-exec.c"
...
# 132 "src/cpu/cpu-exec.c" 3 4
     "l" "x" 
# 132 "src/cpu/cpu-exec.c"
     "\33[0m" "\n", "src/cpu/cpu-exec.c", 132, __func__, (nemu_state.state == NEMU_ABORT ? "\33[1;31m" "ABORT" "\33[0m" : (nemu_state.halt_ret == 0 ? "\33[1;32m" "HIT GOOD TRAP" "\33[0m" : "\33[1;31m" "HIT BAD TRAP" "\33[0m")), nemu_state.halt_pc); fflush(log_fp); } } while (0); } while (0)
