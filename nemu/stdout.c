...
# 79 "src/monitor/sdb/expr.c" 3 4
                                         1
# 79 "src/monitor/sdb/expr.c"
                                                     );
    if (ret != 0) {
      regerror(ret, &re[i], error_msg, 128);
      do { if (!(0)) { (fflush(
# 82 "src/monitor/sdb/expr.c" 3 4
     stdout
# 82 "src/monitor/sdb/expr.c"
     ), fprintf(
# 82 "src/monitor/sdb/expr.c" 3 4
     stderr
# 82 "src/monitor/sdb/expr.c"
...
# 82 "src/monitor/sdb/expr.c"
     "0"
# 82 "src/monitor/sdb/expr.c" 3 4
     , "src/monitor/sdb/expr.c", 82, __extension__ __PRETTY_FUNCTION__); }))
# 82 "src/monitor/sdb/expr.c"
     ; } } while (0);
    }
  }
...
static 
# 95 "src/monitor/sdb/expr.c" 3 4
      _Bool 
# 95 "src/monitor/sdb/expr.c"
           make_token(char *e) {
  int position = 0;
  int i;
  regmatch_t pmatch;
  ...
  while (e[position] != '\0') {
    ...
    for (i = 0; i < (int)(sizeof(rules) / sizeof(rules[0])); i ++) {
      if (regexec(&re[i], e + position, 1, &pmatch, 0) == 0 && pmatch.rm_so == 0) {
        ...
        do { printf("\33[1;34m" "[%s:%d %s] " "match rules[%d] = \"%s\" at position %d with len %d: %.*s" "\33[0m" "\n", "src/monitor/sdb/expr.c", 110, __func__, i, rules[i].regex, position, substr_len, substr_len, substr_start); do { extern FILE* log_fp; extern 
# 110 "src/monitor/sdb/expr.c" 3 4
       _Bool 
# 110 "src/monitor/sdb/expr.c"
       log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "match rules[%d] = \"%s\" at position %d with len %d: %.*s" "\33[0m" "\n", "src/monitor/sdb/expr.c", 110, __func__, i, rules[i].regex, position, substr_len, substr_len, substr_start); fflush(log_fp); } } while (0); } while (0)
                                                                              ;
    ...
    if (i == (int)(sizeof(rules) / sizeof(rules[0]))) {
      ...
      return 
# 155 "src/monitor/sdb/expr.c" 3 4
            0
# 155 "src/monitor/sdb/expr.c"
                 ;
    }
  }

  return 
# 159 "src/monitor/sdb/expr.c" 3 4
        1
# 159 "src/monitor/sdb/expr.c"
            ;
}
word_t vaddr_read(vaddr_t addr, int len);
int eval(int p,int q);
word_t expr(char *e, 
# 163 "src/monitor/sdb/expr.c" 3 4
                    _Bool 
# 163 "src/monitor/sdb/expr.c"
                         *success) {
  if (!make_token(e)) {
    *success = 
# 165 "src/monitor/sdb/expr.c" 3 4
              0
# 165 "src/monitor/sdb/expr.c"
                   ;
    return 0;
  }
...
# 237 "src/monitor/sdb/expr.c" 3 4
_Bool 
# 237 "src/monitor/sdb/expr.c"
...
# 240 "src/monitor/sdb/expr.c"
  ...
  for (i = p; i <= q; i++)
  {
    ...
    {
      return 
# 253 "src/monitor/sdb/expr.c" 3 4
            0 
# 253 "src/monitor/sdb/expr.c"
                  ;
    }
...
# 354 "src/monitor/sdb/expr.c" 3 4
   ((void) sizeof ((
# 354 "src/monitor/sdb/expr.c"
   "Bad expression"
# 354 "src/monitor/sdb/expr.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 354 "src/monitor/sdb/expr.c"
...
# 354 "src/monitor/sdb/expr.c"
   "\"Bad expression\""
# 354 "src/monitor/sdb/expr.c" 3 4
   , "src/monitor/sdb/expr.c", 354, __extension__ __PRETTY_FUNCTION__); }))
# 354 "src/monitor/sdb/expr.c"
                           ;
  }
  else if (p == q)
...
# 391 "src/monitor/sdb/expr.c" 3 4
                                    1
# 391 "src/monitor/sdb/expr.c"
                                        )
  {
    return eval(p+1,q-1);
  }
...
# 409 "src/monitor/sdb/expr.c" 3 4
         ((void) sizeof ((
# 409 "src/monitor/sdb/expr.c"
         "Invalid expression for 0 as mother"
# 409 "src/monitor/sdb/expr.c" 3 4
         ) ? 1 : 0), __extension__ ({ if (
# 409 "src/monitor/sdb/expr.c"
         "Invalid expression for 0 as mother"
...
# 409 "src/monitor/sdb/expr.c"
         "\"Invalid expression for 0 as mother\""
# 409 "src/monitor/sdb/expr.c" 3 4
         , "src/monitor/sdb/expr.c", 409, __extension__ __PRETTY_FUNCTION__); }))
# 409 "src/monitor/sdb/expr.c"
                                                     ;
      }
      else {
    ...
    default: 
# 422 "src/monitor/sdb/expr.c" 3 4
            ((void) sizeof ((
# 422 "src/monitor/sdb/expr.c"
            0
# 422 "src/monitor/sdb/expr.c" 3 4
            ) ? 1 : 0), __extension__ ({ if (
# 422 "src/monitor/sdb/expr.c"
...
# 422 "src/monitor/sdb/expr.c"
            "0"
# 422 "src/monitor/sdb/expr.c" 3 4
            , "src/monitor/sdb/expr.c", 422, __extension__ __PRETTY_FUNCTION__); }))
# 422 "src/monitor/sdb/expr.c"
                     ;break;
    }
  }
