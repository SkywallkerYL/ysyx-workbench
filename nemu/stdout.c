...
static void out_of_bound(paddr_t addr) {
  do { if (!(0)) { (fflush(
# 51 "src/memory/paddr.c" 3 4
 stdout
# 51 "src/memory/paddr.c"
 ), fprintf(
# 51 "src/memory/paddr.c" 3 4
 stderr
# 51 "src/memory/paddr.c"
...
# 51 "src/memory/paddr.c"
 "0"
# 51 "src/memory/paddr.c" 3 4
 , "src/memory/paddr.c", 51, __extension__ __PRETTY_FUNCTION__); }))
# 51 "src/memory/paddr.c"
 ; } } while (0)
                                          ;
}
...
# 67 "src/memory/paddr.c" 3 4
 "x" 
# 67 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 67, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); do { extern FILE* log_fp; extern 
# 67 "src/memory/paddr.c" 3 4
 _Bool 
# 67 "src/memory/paddr.c"
...
# 67 "src/memory/paddr.c" 3 4
 "x" 
# 67 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 67, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); fflush(log_fp); } } while (0); } while (0);
}
# 474 "src/memory/paddr.c"
word_t paddr_read(paddr_t addr, int len) {
...
# 557 "src/memory/paddr.c" 2
# 567 "src/memory/paddr.c"
...
# 586 "src/memory/paddr.c"
struct CACHE
{
  
# 588 "src/memory/paddr.c" 3 4
 _Bool 
# 588 "src/memory/paddr.c"
      valid ;
  
# 589 "src/memory/paddr.c" 3 4
 _Bool 
# 589 "src/memory/paddr.c"
      dirty ;
  uintptr_t tag;
  uint8_t data[(1 << (6))];
};
...
# 652 "src/memory/paddr.c"
          "0"
# 652 "src/memory/paddr.c" 3 4
          , "src/memory/paddr.c", 652, __extension__ __PRETTY_FUNCTION__); }))
# 652 "src/memory/paddr.c"
                   ;
    break;
  }
...
# 781 "src/memory/paddr.c" 3 4
 ((void) sizeof ((
# 781 "src/memory/paddr.c"
 cache
# 781 "src/memory/paddr.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 781 "src/memory/paddr.c"
...
# 781 "src/memory/paddr.c"
 "cache"
# 781 "src/memory/paddr.c" 3 4
 , "src/memory/paddr.c", 781, __extension__ __PRETTY_FUNCTION__); }))
# 781 "src/memory/paddr.c"
              ;
