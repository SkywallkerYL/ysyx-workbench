...
# 71 "src/cpu/cpu-exec.c" 3 4
                                     "l" "x" 
# 71 "src/cpu/cpu-exec.c"
                                              ":", s->pc);
...
static void statistic() {
  setlocale(
# 121 "src/cpu/cpu-exec.c" 3 4
 1
# 121 "src/cpu/cpu-exec.c"
 , "");
...
# 123 "src/cpu/cpu-exec.c"
 " us" "\33[0m" "\n", "src/cpu/cpu-exec.c", 123, __func__, g_timer); do { extern FILE* log_fp; extern 
# 123 "src/cpu/cpu-exec.c" 3 4
 _Bool 
# 123 "src/cpu/cpu-exec.c"
...
# 123 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 123 "src/cpu/cpu-exec.c"
 " us" "\33[0m" "\n", "src/cpu/cpu-exec.c", 123, __func__, g_timer); fflush(log_fp); } } while (0); } while (0);
  do { printf("\33[1;34m" "[%s:%d %s] " "total guest instructions = " "%'" 
# 124 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 124 "src/cpu/cpu-exec.c"
 "\33[0m" "\n", "src/cpu/cpu-exec.c", 124, __func__, g_nr_guest_inst); do { extern FILE* log_fp; extern 
# 124 "src/cpu/cpu-exec.c" 3 4
 _Bool 
# 124 "src/cpu/cpu-exec.c"
...
# 124 "src/cpu/cpu-exec.c" 3 4
 "l" "u" 
# 124 "src/cpu/cpu-exec.c"
 "\33[0m" "\n", "src/cpu/cpu-exec.c", 124, __func__, g_nr_guest_inst); fflush(log_fp); } } while (0); } while (0);
  if (g_timer > 0) do { printf("\33[1;34m" "[%s:%d %s] " "simulation frequency = " "%'" 
# 125 "src/cpu/cpu-exec.c" 3 4
                  "l" "u" 
# 125 "src/cpu/cpu-exec.c"
                  " inst/s" "\33[0m" "\n", "src/cpu/cpu-exec.c", 125, __func__, g_nr_guest_inst * 1000000 / g_timer); do { extern FILE* log_fp; extern 
# 125 "src/cpu/cpu-exec.c" 3 4
                  _Bool 
# 125 "src/cpu/cpu-exec.c"
