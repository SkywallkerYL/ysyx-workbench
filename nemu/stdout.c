...
void init_monitor(int argc, char *argv[])
{
  ...
  init_mtrace();
  if (elf_filein!=
# 137 "src/monitor/monitor.c" 3 4
                 ((void *)0)
# 137 "src/monitor/monitor.c"
