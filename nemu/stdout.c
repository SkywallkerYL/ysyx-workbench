...
void init_monitor(int argc, char *argv[])
{
  ...
  if (elf_filein!=
# 139 "src/monitor/monitor.c" 3 4
                 ((void *)0)
# 139 "src/monitor/monitor.c"
