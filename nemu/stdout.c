...
static void decode_operand(Decode *s, int *dest, word_t *src1, word_t *src2, word_t *imm, int type) {
  ...
  *dest = rd;
  switch (type) {
    ...
    case TYPE_J: do { *imm = (({ struct { int64_t n : 1; } __x = { .n = (((i) >> (31)) & ((1ull << ((31) - (31) + 1)) - 1)) }; (uint64_t)__x.n; })<<19)|(({ struct { int64_t n : 11; } __x = { .n = (((i) >> (12)) & ((1ull << ((19) - (12) + 1)) - 1)) }; (uint64_t)__x.n; }))|(({ struct { int64_t n : 1; } __x = { .n = (((i) >> (20)) & ((1ull << ((20) - (20) + 1)) - 1)) }; (uint64_t)__x.n; })<< 10)|(({ struct { int64_t n : 10; } __x = { .n = (((i) >> (21)) & ((1ull << ((30) - (21) + 1)) - 1)) }; (uint64_t)__x.n; })); } while(0); break;
  }
}
