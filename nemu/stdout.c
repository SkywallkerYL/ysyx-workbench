...
# 43 "src/memory/paddr.c"
 "0"
# 43 "src/memory/paddr.c" 3 4
 , "src/memory/paddr.c", 43, __extension__ __PRETTY_FUNCTION__); }))
# 43 "src/memory/paddr.c"
 ; } } while (0)
                                          ;
}
...
# 59 "src/memory/paddr.c" 3 4
 "x" 
# 59 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 59, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); do { extern FILE* log_fp; extern 
# 59 "src/memory/paddr.c" 3 4
 _Bool 
# 59 "src/memory/paddr.c"
...
# 59 "src/memory/paddr.c" 3 4
 "x" 
# 59 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 59, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); fflush(log_fp); } } while (0); } while (0);
}
...
void mtrace(
# 79 "src/memory/paddr.c" 3 4
           _Bool 
# 79 "src/memory/paddr.c"
                wrrd,paddr_t addr, int len,word_t data)
{
  mtracenum++;
  ...
  wrflag = wrrd?'w':'r';
  if (file == 
# 88 "src/memory/paddr.c" 3 4
             ((void *)0)
# 88 "src/memory/paddr.c"
                 ) {printf("No file!!!!\n");}
...
# 116 "src/memory/paddr.c"
 ...
 fp = fopen(elf_file, "r");
 if (
# 125 "src/memory/paddr.c" 3 4
    ((void *)0) 
# 125 "src/memory/paddr.c"
         == fp)
 {
 ...
 if (
# 156 "src/memory/paddr.c" 3 4
    ((void *)0) 
# 156 "src/memory/paddr.c"
         == shdr)
 {
...
# 163 "src/memory/paddr.c" 3 4
                                0
# 163 "src/memory/paddr.c"
                                        );
 if (0 != a)
 {
  printf("\nfaile to fseek\n");
...
# 182 "src/memory/paddr.c" 3 4
                                               0
# 182 "src/memory/paddr.c"
                                                       );
...
# 229 "src/memory/paddr.c" 3 4
                              0
# 229 "src/memory/paddr.c"
                                      );
  ...
  for (int i = 0; i < elf_head.e_shnum; i++)
 {
  ...
  fseek(fp, shdr[i].sh_offset, 
# 312 "src/memory/paddr.c" 3 4
                              0
# 312 "src/memory/paddr.c"
                                      );
  if(fread(sign_data, sizeof(uint8_t)*shdr[i].sh_size, 1, fp)==1);
                                 ...
                                 jarlflag, int rd ,word_t imm, int rs1,word_t src1)
{
  ...
  if (file == 
# 350 "src/memory/paddr.c" 3 4
             ((void *)0)
# 350 "src/memory/paddr.c"
                 ) {printf("No file!!!!\n");}
...
# 399 "src/memory/paddr.c" 3 4
                                       2
# 399 "src/memory/paddr.c"
                                               )
      {
        ftracenum++;
        if(ftracenum>maxftrace) return;
...
# 418 "src/memory/paddr.c" 3 4
       _Bool 
# 418 "src/memory/paddr.c"
            pccallflag = 0;
...
return value;}
  word_t value =mmio_read(addr, len); mtrace(0,addr,len,value); return value
...
void paddr_write(paddr_t addr, int len, word_t data) {
  ...
  return; }
  mmio_write(addr, len, data); mtrace(1,addr,len,data); return
...
void init_Etrace()
{
  ...
  if (file == 
# 508 "src/memory/paddr.c" 3 4
             ((void *)0)
# 508 "src/memory/paddr.c"
                 )
  {
...
# 517 "src/memory/paddr.c" 3 4
                                                                    _Bool 
# 517 "src/memory/paddr.c"
                                                                         ecall)
{
  etracenum++;
  ...
  if (file == 
# 523 "src/memory/paddr.c" 3 4
             ((void *)0)
# 523 "src/memory/paddr.c"
                 ) {printf("No file!!!!\n");}
  if (ecall)
