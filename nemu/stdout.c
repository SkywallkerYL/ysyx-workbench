...
# 24 "src/monitor/sdb/sdb.c" 3 4
                          0
# 24 "src/monitor/sdb/sdb.c"
                               ;
...
# 31 "src/monitor/sdb/sdb.c"
  ...
  if (line_read) {
    free(line_read);
    line_read = 
# 35 "src/monitor/sdb/sdb.c" 3 4
               ((void *)0)
# 35 "src/monitor/sdb/sdb.c"
                   ;
  }
...
# 65 "src/monitor/sdb/sdb.c"
                         ," ");
  if (time == 
# 66 "src/monitor/sdb/sdb.c" 3 4
             ((void *)0)
# 66 "src/monitor/sdb/sdb.c"
                 ) {
    cpu_exec(1);
    return 0;
  }
...
static int cmd_info(char *args){
  char *arg = strtok(
# 82 "src/monitor/sdb/sdb.c" 3 4
                    ((void *)0)
# 82 "src/monitor/sdb/sdb.c"
                        ," ");
  if (strcmp(arg,"r")==0)
  {
    isa_reg_display();
...
static int cmd_x(char *args){
  char *N = strtok(
# 108 "src/monitor/sdb/sdb.c" 3 4
                  ((void *)0)
# 108 "src/monitor/sdb/sdb.c"
                      ," ");
  char *EXPR = strtok(
# 109 "src/monitor/sdb/sdb.c" 3 4
                     ((void *)0)
# 109 "src/monitor/sdb/sdb.c"
                         ," ");
  int addrn ;
  sscanf(N,"%d",&addrn);
  paddr_t addexpr;
...
# 136 "src/monitor/sdb/sdb.c" 3 4
   _Bool 
# 136 "src/monitor/sdb/sdb.c"
        success = 
# 136 "src/monitor/sdb/sdb.c" 3 4
                  1
# 136 "src/monitor/sdb/sdb.c"
...
static int cmd_pt(char* args){
  int len;
  if (args == 
# 151 "src/monitor/sdb/sdb.c" 3 4
             ((void *)0)
# 151 "src/monitor/sdb/sdb.c"
                 )
  {
    len = 100;
  }
...
# 191 "src/monitor/sdb/sdb.c" 3 4
     _Bool 
# 191 "src/monitor/sdb/sdb.c"
          success = 
# 191 "src/monitor/sdb/sdb.c" 3 4
                    1
# 191 "src/monitor/sdb/sdb.c"
...
static int cmd_d (char *args){
  char *arg = strtok(
# 216 "src/monitor/sdb/sdb.c" 3 4
                    ((void *)0)
# 216 "src/monitor/sdb/sdb.c"
                        ," ");
  int NO = 0;
  sscanf(arg,"%d",&NO);
...
static int cmd_help(char *args) {
  ...
  char *arg = strtok(
# 254 "src/monitor/sdb/sdb.c" 3 4
                    ((void *)0)
# 254 "src/monitor/sdb/sdb.c"
                        , " ");
  int i;

  if (arg == 
# 257 "src/monitor/sdb/sdb.c" 3 4
            ((void *)0)
# 257 "src/monitor/sdb/sdb.c"
                ) {
...
# 285 "src/monitor/sdb/sdb.c"
    ...
    char *cmd = strtok(str, " ");
    if (cmd == 
# 290 "src/monitor/sdb/sdb.c" 3 4
              ((void *)0)
# 290 "src/monitor/sdb/sdb.c"
                  ) { continue; }
    ...
    if (args >= str_end) {
      args = 
# 297 "src/monitor/sdb/sdb.c" 3 4
            ((void *)0)
# 297 "src/monitor/sdb/sdb.c"
                ;
    }
